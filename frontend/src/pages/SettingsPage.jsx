...
import { Sun, Moon, Monitor, Save, User as UserIcon, Home, ArrowLeft, Crown, Sparkles, CreditCard, Bookmark, Trash2, Play, Inbox, AlertCircle, MessageCircle, Mail, Lock, Shield } from 'lucide-react';
...
const SettingsPage = () => {
  ...
  const handleChangeEmail = async (e) => {
    ...
    try {
      ...
      toast({
        title: 'Email updated ✅',
        description: `Log in with ${newEmail} from now on.`,
      });
      setNewEmail('');
      setEmailPassword('');
    } catch (err) {
