      ...
      <DialogContent className="max-w-3xl p-0 bg-black/95 border border-white/10 max-h-[90vh] overflow-y-auto">
        <div className="p-8">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h2 className="text-3xl font-bold text-white mb-2">Install StreamFlix</h2>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">Visit StreamFlix in Google Chrome on your Android phone</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">StreamFlix will be added to your home screen!</p>
                    </div>
                  </div>

                  <div className="bg-green-500/20 border border-green-500/40 rounded-lg p-4 mt-4">
                    <p className="text-green-400 font-semibold text-sm">✓ Done! Open StreamFlix from your home screen like any other app.</p>
                  </div>
                </div>
              </div>
            </TabsContent>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">Visit StreamFlix using Safari (not Chrome)</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">The StreamFlix icon will appear on your home screen!</p>
                    </div>
                  </div>

                  <div className="bg-green-500/20 border border-green-500/40 rounded-lg p-4 mt-4">
                    <p className="text-green-400 font-semibold text-sm">✓ Done! Launch StreamFlix from your home screen like a native app.</p>
                  </div>
                </div>
              </div>
            </TabsContent>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">Visit StreamFlix on your computer</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-white font-semibold">Click "Install StreamFlix"</p>
                      <p className="text-white/70 text-sm">Or go to Menu (⋮) → "Install StreamFlix..."</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">StreamFlix will open in its own window!</p>
                    </div>
                  </div>

                  <div className="bg-green-500/20 border border-green-500/40 rounded-lg p-4 mt-4">
                    <p className="text-green-400 font-semibold text-sm">✓ Done! Find StreamFlix in your applications or launch from your desktop.</p>
                  </div>
                </div>
              </div>
            </TabsContent>
